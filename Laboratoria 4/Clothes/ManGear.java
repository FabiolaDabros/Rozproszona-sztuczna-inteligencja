...
public class ManGear extends Gear  {             // dziedziczenie
    boolean purchased;
    double price;

    public ManGear( String kind, int size, String color, double price, short year) {
    ...
    public void trySthOn(int size) {
        try {                                                                 // obsługa własnego wyjątku
            ...
            System.out.println(" You have bought wrong size! It's: " + size + "\n I'm so sorry. It does'nt suit you. ");
        }
    }
